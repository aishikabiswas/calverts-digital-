...
//   "Performance Marketing (Google Ads, Meta, TikTok, LinkedIn)",
//   "SEO & Organic Growth",
...
//       {/* Subtle dotted background, with masked edges */}
//       <div
//         aria-hidden="true"
...
//             >
//               <span className="inline-flex h-6 w-6 items-center justify-center rounded-full bg-orange-300/80 text-white text-sm font-bold">
//                 {/* Example icon: replace with custom SVG or emoji */}
...
//         <motion.div
//           variants={item}
//           className="mt-10 w-full rounded-2xl border border-orange-300/40 bg-gradient-to-r from-orange-300/15 to-white/10 backdrop-blur-sm overflow-hidden"
//         >
