        ...
        <div className="container mx-auto px-4 py-24 sm:py-32 relative z-10 flex-1 flex flex-col">
          <div className="mx-auto max-w-4xl text-center flex-1 flex flex-col justify-center">
            ...
            <motion.div
              ...
              className="mb-6"
            >
              <Badge variant="secondary" className="bg-orange-300 inline-flex items-center gap-2 px-4 py-2 text-sm">
                <Sparkles className="h-4 w-4" />
            ...
            <motion.div
              ...
              className="mb-8"
            >
              <h1 id="main-title" className="text-2xl font-bold tracking-tight text-foreground sm:text-6xl lg:text-6xl">
                Crafting <strong>Next-Gen</strong> Digital Experiences <br />
                from <strong>Kolkata</strong> to the <em className="italic">World</em>.
              </h1>
            </motion.div>
            ...
            <motion.p
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.5, delay: 0.2 }}
              className="mx-auto mb-5 max-w-l text-lg text-muted-foreground"
            >
              We are Calverts Digital Technology Pvt. Ltd.—a people-first digital agency fusing AI, data, and design to
              build impactful solutions that drive measurable growth.
            </motion.p>
            ...
            >
              ...
              <div className="flex items-center justify-center gap-4 flex-wrap">
                ...
                <a href="/work" className="group">
                  <div className="cursor-pointer border border-border bg-transparent gap-2 h-[60px] flex items-center p-[10px] rounded-full">
                    <div className="h-[40px] rounded-full flex items-center justify-center text-foreground">
                      <p className="font-medium tracking-tight mr-3 ml-3 flex items-center gap-2 justify-center text-base">
                        Explore Our Work
                      </p>
                    </div>
                    <div className="text-muted-foreground group-hover:ml-2 ease-in-out transition-all size-[24px] flex items-center justify-center rounded-full border-2 border-border">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="14"
                        height="14"
